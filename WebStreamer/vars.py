...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(environ.get("20786332"))
    API_HASH = str(environ.get("173e50972dc21095b5e9d80affdee354"))
    BOT_TOKEN = str(environ.get("5992438983:AAGCJe_XTqa24wiJH51iaOvztLO6YSu4-Uw"))
    SLEEP_THRESHOLD = int(environ.get("SLEEP_THRESHOLD", "60"))  # 1 minte
    WORKERS = int(environ.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    BIN_CHANNEL = int(
        environ.get("-1001791730806", None)
    ...
    ALLOWED_USERS = [x.strip("@zjgkonzj ") for x in str(environ.get("ALLOWED_USERS", "") or "").split(",") if x.strip("@ ")]
